...
/// ★ 수정: ItemType에 FarmProduce, Companion 추가
/// </summary>
...
public class ItemData : ScriptableObject
{
    ...
    [Tooltip("ItemType == Equipment 일 때만 사용")]
    public EquipmentStats equipmentStats;

    [Header("소모품 효과 (Consumable 타입)")]
    [Tooltip("ItemType == Consumable 일 때만 사용")]
