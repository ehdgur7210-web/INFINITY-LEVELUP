...
public static class QuestManagerExtensions
{
    ...
    /// 퀘스트 데이터 가져오기 (저장용)
    /// </summary>
    public static QuestSaveData GetQuestData(this QuestManager manager)
    {
        QuestSaveData data = new QuestSaveData();

        // TODO: 실제 QuestManager 구조에 맞게 수정
        List<int> activeQuestIDs = new List<int>();
        List<int> completedQuestIDs = new List<int>();
        List<QuestProgress> progressList = new List<QuestProgress>();

        data.activeQuestIDs = activeQuestIDs.ToArray();
        data.completedQuestIDs = completedQuestIDs.ToArray();
        data.questProgresses = progressList.ToArray();
    ...
    /// 퀘스트 데이터 로드 (로드용)
    /// </summary>
    public static void LoadQuestData(this QuestManager manager, QuestSaveData questData)
    {
