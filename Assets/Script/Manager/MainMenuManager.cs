...
public class MainMenuManager : MonoBehaviour
{
    ...
    {
        GameSettings s = GameDataBridge.CurrentData?.settings;

        if (masterVolumeSlider != null)
            masterVolumeSlider.value = s != null ? s.masterVolume : 1f;

        if (bgmVolumeSlider != null)
            bgmVolumeSlider.value = s != null ? s.bgmVolume : 0.7f;

        if (sfxVolumeSlider != null)
            sfxVolumeSlider.value = s != null ? s.sfxVolume : 0.8f;
    ...
    private void OnMasterVolumeChanged(float value)
    {
        ...
        if (GameDataBridge.CurrentData != null)
            GameDataBridge.CurrentData.settings.masterVolume = value;
    }
    ...
    private void OnQualityChanged(int index)
    {
        ...
        if (GameDataBridge.CurrentData != null)
            GameDataBridge.CurrentData.settings.graphicsQuality = index;
    }
