...
public class QuestManager : MonoBehaviour
{
    ...
    public QuestSaveData GetQuestData()
    {
        ...
        if (currentQuest != null && currentQuest.questData != null)
        {
            ...
            progresses.Add(currentQuest);
            data.questProgresses = progresses.ToArray();
        }

        Debug.Log($"[QuestManager] 저장: 완료 {completedQuestIDs.Count}개, 현재인덱스 {currentQuestIndex}");
        return data;
    }
    ...
    public void LoadQuestData(QuestSaveData data)
    {
        ...
        Debug.Log($"[QuestManager] 로드: 완료 {completedQuestIDs.Count}개, 인덱스 {currentQuestIndex}");
