...
public class SceneTransitionManager : MonoBehaviour
{
    ...
    /// <summary>
    /// ✅ 씬 전환 후 AudioListener 중복 제거
    /// DontDestroyOnLoad 카메라와 새 씬 카메라가 동시에 존재하면 경고 발생
    /// </summary>
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        {
            // DontDestroyOnLoad에서 넘어온 것(첫번째)을 비활성화하고 새 씬 것을 살림
            ...
            Debug.Log($"[SceneTransitionManager] AudioListener 중복 제거: {listeners.Length - 1}개 비활성화");
        }
    }
